import MergeStudentCard from "../../../components/MergeStudentCard/MergeStudentCard";
...
const SuggestedStudentMerge = (): JSX.Element => {
    ...
    return (
          <div className={styles.container}>
            {fakeStudentPairs.map(([studentIdA, studentIdB], index) => (
              <div key={index} className={styles.cardContainer}>
                <MergeStudentCard studentIdA={studentIdA} studentIdB={studentIdB} />
              </div>
            ))}
          </div>
      );
