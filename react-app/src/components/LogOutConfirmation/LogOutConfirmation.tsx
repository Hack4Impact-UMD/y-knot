...
interface LogOutConfirmationProps {
  ...
  const LogOutConfirmation: React.FC<LogOutConfirmationProps> = ({onClose, onConfirm}) => {
    ...
    return (
        <div className={styles.logOutConfirmation}>
            <div className={styles.popup}>
                ...
                <div>
                    <button onClick={handleConfirm}><p>Yes</p></button>
                    <button onClick={handleReject}><p>No</p></button>
                </div>
            </div>
        </div>
    )
